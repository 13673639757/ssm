...
public class aaa {
    ...
    public static void main(String[] args) {
        ...
        for (List<String> list : lists) {
                 ...
                 aa.append("INSERT INTO   doct_dept (doct_code,doct_name,dept_code,dept_name)  values('");
                 aa.append(list.get(0).trim()).append("','");
                aa.append(list.get(1).trim()).append("','");
                aa.append(list.get(2).trim()).append("','");
                aa.append(list.get(3).trim()).append("');");
